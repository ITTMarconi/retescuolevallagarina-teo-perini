...
// Function to create custom school marker icon with logo
const createSchoolIcon = (school, apiUrl) => {
  ...
  if (school.logo) {
    ...
    // Fallback to red school icon if no logo
    return L.divIcon({
...
export default function MapComponent({ routes, selectedRouteId, apiUrl }) {
      ...
      >
        ...
        {uniqueSchools.map((school) => (
          <Marker
            ...
            icon={createSchoolIcon(school, apiUrl)}
          >
            <Popup>
              <div className={styles.popupContent}>
